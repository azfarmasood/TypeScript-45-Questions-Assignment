...
while(InvitedGuest.length > 2) {
    ...
    console.log(`Sorry, ${DonthaveSpaceForOtherGuest}, I can't invite you`)
}

console.log("--------New Guest List-----------")

InvitedGuest.forEach(function(NewGuestList){
    console.log(`Assala mo Alikum My Dear Friends ${NewGuestList},You are still invited Thank you.`)
});
