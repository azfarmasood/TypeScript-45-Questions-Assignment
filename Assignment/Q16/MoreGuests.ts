...
// Adding more 5 Guest at the end
...
console.log("------New Guest List Updated-------")


InvitedGuest.forEach(function(NewGuestList){
    console.log(`Assala mo Alikum My Dear Friends ${NewGuestList}, you are cordially invited to Lunch and Dinner Please join us on Block A-North-Nazimabad Karachi on Saturday at 2:00 PM till 8:pm We look forward to your presence Thank you`)
});